...
//Code Here
let myFirstVehicle = new Vehicle(6, 'white', 10)
...
let myFirstMotorcycle = new Motorcycle(6, 'purple', 10, 'Honda', 'Yes')
...
let myFirstBoat = new Boat(5, 'red', 50, 'Executor', 'Star Destroyer', false)
